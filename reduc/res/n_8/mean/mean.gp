...
set output "mean.png"       # 指定生成的图像文件名

plot 'mean.txt' using 2:xtic(1) ti col, \
     '' using 3 ti col, \
     '' using 4 ti col, \
     '' using 5 ti col, \
     '' u 0:2:2 ti col with labels offset -7,0.6, \
     '' u 0:3:3 ti col with labels offset -2,-1, \
      '' u 0:4:4 ti col with labels offset 2,0.6, \
